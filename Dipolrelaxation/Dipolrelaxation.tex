...
\newcommand{\Datum}{29.10.2018}
\newcommand{\Datumabgab}{09.11.2018}
...
\newcommand{\Versuch}{Dipolrelaxation}
\newcommand{\Nummer}{V48}
...
\date{Durchführung: \Datum, 1. Korrektur: \Datumabgab}

% % % % % % % % % % % % % % % % % % % % % % % % % % % %

\pagestyle{scrheadings}
\ihead[]{\small{\textcolor{hellgrau}{Versuchsnummer:\\ \ \ \ \Nummer \\}}}
