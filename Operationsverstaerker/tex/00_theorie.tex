...
\noindent Um den Umgang mit realen Operationsverstärkern bei Berechnungen und in Schaltungen zu vereinfachen, wird das Modell des idealen Operationsverstärkers eingeführt:
...
\noindent Für reale Operationsverstärker gibt es weitere Eigenschaften, die erläutert werden müssen:
...
\noindent Das Gegenstück zum Integrator ist der Differentiator. Dieser wird gem \ref{abb:diff} aufgebaut.
\begin{equation}
...
\noindent Die Integration erfolgt folgendermaßen:
\begin{equation}
