...
\end{align}
Mit einer durchschnittlichen Energie von $\SI{4}{\giga\electronvolt}$ (auf Meereshöhe) \cite{PGD} sind Myonen relativistisch und können trotz einer Lebensdauer von $\SI{2.197}{\micro\second}$ \cite{PDG} den Erdboden erreichen.\par
