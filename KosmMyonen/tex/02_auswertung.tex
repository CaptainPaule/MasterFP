...
\noindent Aus \autoref{abb:res} ergibt sich aus der Halbwertsbreite eine Zeitauflösung von $\Delta t_k = 24,03 \, \text{ns}$
...
\label{tab:Fit}
\end{tabular}
\caption{Ergebnisse für den Koeffizienten A  der Ausgleichsrechnung zur Bestimmung der Myon Lebensdauer}
\end{table}
...
\noindent durchgeführt. Hieraus folgt für die Zerfallskonstante $\lambda$ unter Berücksichtigung der Ergebnisse der Ausgleichsrechnung Tabelle 1 und \ref{eq:LogDecayLaw}
